    ...
    <div class="mx-auto mt-40 w-full md:w-auto px-4">
      ...
      <div class="mt-10 mx-auto w-full max-w-3xl">
        <div class="flex items-start justify-between gap-4">
          <div>
            <div class="text-24-semibold text-text-strong">Cadence</div>
            <div class="mt-1 text-14-regular text-text-weak">对话式日用 AI 客户端（保留完整 OpenCode 执行能力）。</div>
          </div>
              ...
              >
                {(project) => (
                  <div class="flex gap-2 items-center">
                    ...
                    <Button size="large" variant="secondary" class="px-3" onClick={() => openProjectCode(project.worktree)}>
